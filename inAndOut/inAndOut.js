    ...
    var randomPoints = function( radiusOfRegion, numberOfPoints ) {
        var result = {};
        ...
        var insideMaterial = new THREE.PointCloudMaterial( {color: 0xFF0000, size: 2.0} );
        var outsideMaterial = new THREE.PointCloudMaterial( {color: 0x00FF00, size: 2.0} );
    ...
    var triangle = function ( radius ) {
        ...
        var edgeMaterial = new THREE.LineBasicMaterial( {color: 0x2266EE, linewidth: 8.0} );
        var vertexMaterial = new THREE.PointCloudMaterial( {color: 0x000000, size: 4.0} );
